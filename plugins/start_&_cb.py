...
async def start(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            ...
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/genanimechat')
        ],
        [
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/genanimeofc'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/genanimechat')],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/genanimechat'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
            ])
        )
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/genanimechat'), InlineKeyboardButton("ᴄᴏᴍᴍᴀɴᴅs •", callback_data="help")],
