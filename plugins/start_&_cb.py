...
async def start(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/ClipMateBhai'),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/ClipMateBhai')
        ],
        [
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/ClipMateBhai'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/CodeflixSupport')],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/ClipMateBhai'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
            ])
        )
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/ClipMateBhai'), InlineKeyboardButton("ᴄᴏᴍᴍᴀɴᴅs •", callback_data="help")],
                [InlineKeyboardButton("• ᴅᴇᴠᴇʟᴏᴘᴇʀ", url='https://t.me/Prime_Movie_Request_bot'), InlineKeyboardButton("ɴᴇᴛᴡᴏʀᴋ •", url='https://t.me/Prime_Movie_Request_bot')],
...
async def donation(client, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url='https://t.me/Prime_Movie_Request_bot')]
    ])
...
async def getpremium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("ᴏᴡɴᴇʀ", url="https://t.me/Prime_Movie_Request_bot"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
...
async def premium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("sᴇɴᴅ ss", url="https://t.me/Prime_Movie_Request_bot"), InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
    ])
